...
public class Runner {
    ...
    private static final String WEB_EXAMPLES_DIR = "vertx-web-kotlin";
    private static final String WEB_EXAMPLES_JAVA_DIR = WEB_EXAMPLES_DIR + "/src/main/java/";
    private static final String WEB_EXAMPLES_KOTLIN_DIR = WEB_EXAMPLES_DIR + "/src/main/kotlin/";
    ...
    public static void runExample(Class clazz) {
        runExample(WEB_EXAMPLES_KOTLIN_DIR, clazz, new VertxOptions().setClustered(false), null);
    }

    public static void runExampleWithCluster(Class clazz) {
        runExample(WEB_EXAMPLES_KOTLIN_DIR, clazz, new VertxOptions().setClustered(true), null);
    }
